...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Lakshmana Sattineedi" => "lakshmana.sattineedi@utu.global" }
  # Or just: spec.author    = "Lakshmana Sattineedi"
  # spec.authors            = { "Lakshmana Sattineedi" => "lakshmana.sattineedi@utu.global" }
  # spec.social_media_url   = "https://twitter.com/Lakshmana Sattineedi"
  ...
  spec.source       = { :git => "https://github.com/UTU-Global/Mobile.iOS.UI.git" }
  ...
  spec.resources = "UTUFramework/Resources/**/*.{png,xib,json,plist,ttf,xcassets,sqlite,bundle,js,pdf}"
